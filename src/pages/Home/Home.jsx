...
const slides = [
  { title: "Complete Tasks & Earn Money", subtitle: "Join thousands of workers earning daily by completing simple micro tasks", bg: "from-violet-900 to-violet-700" },
  { title: "Post Tasks & Get Results Fast", subtitle: "Buyers can post tasks and get them completed by skilled workers worldwide", bg: "from-indigo-900 to-indigo-700" },
  { title: "Safe & Secure Payments", subtitle: "Your earnings are protected. Withdraw anytime with our secure payment system", bg: "from-purple-900 to-purple-700" },
];
...
const Home = () => {
  ...
  const topWorkers = Array.isArray(data) ? data : [];

  return (
    <div>
      <Swiper modules={[Autoplay, Pagination, Navigation]} autoplay={{ delay: 3000 }} pagination={{ clickable: true }} navigation loop className="w-full">
        {slides.map((slide, i) => (
          <SwiperSlide key={i}>
